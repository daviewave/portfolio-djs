...
export const Section = styled.section`
  ...
  padding: ${(props) => (props.nopadding ? "0" : "20px 20px 0")};
  margin: 0 auto;
  max-width: 92vw;
...
export const ButtonSection = styled.div`
  ...
  gap: 2px; /* Use 'gap' instead of 'space' */
  width: 88vw;
  max-width: 1200px;
...
export const ButtonFront = styled.button`
  ...
  background: ${({ alt }) =>
    alt
      ? "linear-gradient(180deg, #4a66e2ff 0%, #a1a8d3ff 50%, #b7b3eeff 100%)"
      : "linear-gradient(180deg, #4a66e2ff 0%, #a1a8d3ff 50%, #b7b3eeff 100%)"};
  opacity: ${({ disabled }) => (disabled ? ".5" : "1")};
  transition: 0.4s ease;
  font-size: ${({ alt }) => (alt ? "20px" : "24px")};
